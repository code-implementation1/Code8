...
class AnchorGenerator(nn.Cell):
    ...
    Args:
        ...
        center_offset (float): The offset of center in proportion to anchors'
            width and height. By default, it is 0.5.
    Examples:
    ...
    def gen_single_level_base_anchors(self,
        ...
        Returns:
            Tensor: Anchors in a single-level feature map.
        """
        w = base_size
        h = base_size
        if center is None:
        ...
        base_anchors = ops.round(ops.stack(base_anchors, axis=-1))
    ...
    def valid_flags(
        ...
        for i in range(self.num_levels):
            ...
            h, w = pad_shape[:2]
            valid_feat_h = ops.minimum(ops.ceil(h / anchor_stride[1]), feat_h)
            valid_feat_w = ops.minimum(ops.ceil(w / anchor_stride[0]), feat_w)
