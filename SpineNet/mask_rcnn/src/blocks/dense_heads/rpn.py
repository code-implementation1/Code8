...
class RPNHead(nn.Cell):
    ...
    def __init__(
        ...
        self.num_layers = 5
        self.real_ratio = ms.ops.ones((1, 1), self.ms_type)
        ...
        self.fill = ops.Fill()
        self.placeh1 = ms.ops.ones((1,), self.ms_type)
        ...
        self.total_loss = ms.ops.zeros((1,), self.ms_type)
        self.clsloss = ms.ops.zeros((1,), self.ms_type)
        self.regloss = ms.ops.zeros((1,), self.ms_type)
    ...
    def get_targets(
        ...
        train_img_metas = ops.concat(
            (img_metas[::, 4:6], ops.ones_like(img_metas[::, 0:1])),
            axis=1
        )
        for i in range(self.train_batch_size):
            ...
            (
                ...
                bboxes=anchor_using_list, gt_valids=gt_valids_i
            )
