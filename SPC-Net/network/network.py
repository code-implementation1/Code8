...
class _AtrousSpatialPyramidPoolingModule(nn.Cell):
    ...
    def construct(self, x):
        ...
        img_features = P.ResizeBilinearV2(True)(img_features, (x_size[2], x_size[3]))
        out = img_features
...
class DeepV3Plus(nn.Cell):
    ...
    def decoder(self, x, low_level):
        ...
        dec0_up = P.ResizeBilinearV2(True)(dec0_up, (low_level_size[2], low_level_size[3]))
    ...
    def construct(self, x):
        ...
        main_out = P.ResizeBilinearV2(True)(main_out, (x_size[2], x_size[3]))
        return main_out
